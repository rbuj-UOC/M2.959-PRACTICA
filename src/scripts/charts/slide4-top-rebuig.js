...
export function createSlide4TopRebuig(data) {
    const yearCtrl = d3.select('#pressure-year-2');
    const yearDisp = d3.select('#pressure-year-display-2');
    const provCtrl = d3.select('#pressure-provincia-2');
    let isActive = false;
    ...
    function render() {
        ...
        topBar('#chart-4-1', rows, d => d.kg_no_selectiva_per_hab_dia, 'Top rebuig kg/hab./dia');
    }
